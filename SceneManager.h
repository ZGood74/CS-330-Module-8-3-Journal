...
#include <GLFW/glfw3.h> // GLFW for input handling
#include <string>
#include <vector>
#include <glm/glm.hpp>
...
private:
    ...
    GLFWwindow* m_window; // Store pointer to GLFW window
...
public:
    ...
    // Pass the GLFW window to the scene manager for input handling
